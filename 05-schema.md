...
Design(
  ...
  rationales: [
    Rationale(id: "r_wall", author: Human("nakag"), basis: Assumption,
              note: "剛性未評価のため仮置き。DFM検証後に確定。板幅64はφ55ボアとの面内リガメント(64-55)/2=4.5mmを確保する(最小肉厚2.5に対し余裕)。下限3.0はM4の3点評価+narrowで確定: t=2.0はフィレットr2不能(E-FEATURE-FAIL)、t=2.2は最小肉厚Fail(実測2.2<2.5)、narrow提案は≥2.502 — 探索粒度と製造ばらつきを見込み安全側で3.0を維持(2026-07-12)", timestamp: "2026-07-11T00:00:00Z"),
